...
{
	if (region.bc.aG === region.bw.aG)
	{
		return 'on line ' + region.bc.aG;
	}
	return 'on lines ' + region.bc.aG + ' through ' + region.bw.aG;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bB: fragment, bE: host, bP: path, bR: port_, bV: protocol, bW: query};
	});
...
var $author$project$Main$nextId = function (id) {
	return id + 1;
};
var $author$project$Main$rootId = 0;
var $author$project$Main$emptyModel = {
	Q: $author$project$Main$nextId($author$project$Main$rootId),
	x: A3(
		$elm$core$Dict$insert,
		$author$project$Main$rootId,
		{s: _List_Nil, E: false, y: $author$project$Main$rootId, Z: $author$project$Main$rootId, H: 'My List'},
		$elm$core$Dict$empty),
	bf: 5
};
var $author$project$Main$Model = F3(
	function (nodes, nextId, uiSize) {
		return {Q: nextId, x: nodes, bf: uiSize};
	});
...
var $author$project$Main$NodeInfo = F5(
	function (id, owner, text, crossedOut, children) {
		return {s: children, E: crossedOut, y: id, Z: owner, H: text};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$nodeInfoDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$NodeInfo,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'owner', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'text', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'crossedOut', $elm$json$Json$Decode$bool),
	A2(
...
var $author$project$Main$modelDecoder = A4(
	...
	A2(
		$elm$json$Json$Decode$field,
		'nodes',
		A2($elm_community$json_extra$Json$Decode$Extra$dict2, $elm$json$Json$Decode$int, $author$project$Main$nodeInfoDecoder)),
...
var $author$project$Main$init = function (value) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$modelDecoder, value);
	if (!_v0.$) {
		var model = _v0.a;
...
var $author$project$Main$crossNode = function (node) {
...
var $author$project$Main$encodeNodeInfo = function (node) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$int(node.y)),
				_Utils_Tuple2(
				'owner',
				$elm$json$Json$Encode$int(node.Z)),
				_Utils_Tuple2(
				'text',
				$elm$json$Json$Encode$string(node.H)),
				_Utils_Tuple2(
				'crossedOut',
				$elm$json$Json$Encode$bool(node.E)),
				_Utils_Tuple2(
				'children',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, node.s))
			]));
};
var $author$project$Main$encodeNodes = A2($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $author$project$Main$encodeNodeInfo);
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nodes',
				$author$project$Main$encodeNodes(model.x)),
				_Utils_Tuple2(
				'nextId',
...
var $author$project$Main$removeNode = F2(
	function (id, nodes) {
		var _v0 = A2($elm$core$Dict$get, id, nodes);
		if (_v0.$ === 1) {
			return nodes;
		} else {
			var nodeInfo = _v0.a;
			var removeChildren = A3(
				$elm$core$List$foldr,
				$elm$core$Basics$composeR,
				function (x) {
					return x;
				},
				A2($elm$core$List$map, $author$project$Main$removeNode, nodeInfo.s));
			return A3(
				...
				removeChildren(
					A2($elm$core$Dict$remove, id, nodes)));
		}
	});
var $author$project$Storage$set = _Platform_outgoingPort('set', $elm$core$Basics$identity);
var $author$project$Main$updateNodes = F2(
	function (f, model) {
		return _Utils_update(
			model,
			{
...
var $author$project$Main$updateOwner = F3(
	function (owner, id, model) {
		return _Utils_update(
			model,
			{
				x: A3(
	...
	function (msg, model) {
		...
		switch (msg.$) {
			case 0:
				...
				return noMessage(
					A3(
						$author$project$Main$updateOwner,
						owner,
						model.Q,
						_Utils_update(
							model,
							{
								...
								x: A3(
									$elm$core$Dict$insert,
									model.Q,
									{s: _List_Nil, E: false, y: model.Q, Z: owner, H: ''},
									model.x)
							})));
			case 1:
				var id = msg.a;
				return noMessage(
					A2(
						$author$project$Main$updateNodes,
						A2(
							$elm$core$Dict$update,
							id,
							$elm$core$Maybe$map($author$project$Main$crossNode)),
						model));
			case 2:
				var id = msg.a;
				return noMessage(
					A2(
						$author$project$Main$updateNodes,
						$author$project$Main$removeNode(id),
						model));
			case 3:
				var id = msg.a;
				var text = msg.b;
...
var $rtfeldman$elm_css$Css$row = {a4: 0, aD: 0, I: 'row'};
...
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ah: charsProcessed, an: hash, ab: seed, as: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.an)) ? (data.ab ^ A2(
		$robinheghan$murmur3$Murmur3$multiplyBy,
		$robinheghan$murmur3$Murmur3$c2,
		A2(
			$robinheghan$murmur3$Murmur3$rotlBy,
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.an)))) : data.ab;
	var h0 = acc ^ data.ah;
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {ah: data.ah + 1, an: res, ab: data.ab, as: data.as + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bs: charset, cm: declarations, bF: imports, bN: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bs: $elm$core$Maybe$Nothing, bF: _List_Nil, bN: _List_Nil, b2: snippets};
};
...
var $author$project$Main$Node = $elm$core$Basics$identity;
...
var $author$project$Main$makeNode = F2(
	function (dict, id) {
		return A2(
			$elm$core$Maybe$map,
			function (nodeInfo) {
				return {
					s: A2(
						...
						$author$project$Main$makeNode(dict),
						nodeInfo.s),
					E: nodeInfo.E,
					y: id,
					H: nodeInfo.H
...
var $author$project$Main$size = F2(
	function (model, x) {
		return $rtfeldman$elm_css$Css$px(model.bf * x);
	});
...
var $author$project$Main$TextChange = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $rtfeldman$elm_css$Css$absolute = {aI: 0, I: 'absolute'};
...
var $rtfeldman$elm_css$Css$calc = F3(
	function (firstExpr, expression, secondExpr) {
		var withoutCalcStr = function (l) {
			return A2($elm$core$String$startsWith, 'calc(', l.I) ? A2($elm$core$String$dropLeft, 4, l.I) : l.I;
		};
		...
		var value = A2(
			...
			_List_fromArray(
				[calcs]));
		return {bq: 0, ak: 0, p: 0, aF: 0, ao: 0, O: 0, ap: 0, aq: 0, X: 0, Y: 0, F: 0, av: 0, I: value};
	});
...
var $rtfeldman$elm_css$Css$relative = {aI: 0, I: 'relative'};
...
var $author$project$Main$crossedOut = F2(
	function (model, el) {
		var height = 2;
		return A2(
							...
							_List_fromArray(
								[
									...
									A3(
										...
										A2($author$project$Main$size, model, height / 2))),
									$rtfeldman$elm_css$Css$width(
									$rtfeldman$elm_css$Css$pct(100)),
									$rtfeldman$elm_css$Css$height(
									A2($author$project$Main$size, model, height)),
...
var $author$project$Main$styleFlex = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$NewNode = function (a) {
	return {$: 0, a: a};
};
...
var $rtfeldman$elm_css$Css$transparent = {D: 0, I: 'transparent'};
var $author$project$Main$viewNodeActionButton = F2(
	function (msg, inner) {
		return A2(
...
var $author$project$Main$viewAddButton = function (owner) {
	return A2(
		$author$project$Main$viewNodeActionButton,
		$author$project$Main$NewNode(
			{Z: owner}),
		_List_fromArray(
			[
...
var $author$project$Main$CrossNode = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$viewCrossoutButton = function (id) {
	return A2(
		$author$project$Main$viewNodeActionButton,
		$author$project$Main$CrossNode(id),
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text('-')
			]));
...
var $author$project$Main$viewMarker = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$width(
						A2($author$project$Main$size, model, 5)),
						$rtfeldman$elm_css$Css$height(
						A2($author$project$Main$size, model, 5)),
						$rtfeldman$elm_css$Css$borderRadius(
						A2($author$project$Main$size, model, 10)),
						$rtfeldman$elm_css$Css$backgroundColor(
						A3($rtfeldman$elm_css$Css$rgb, 0, 0, 0)),
...
var $author$project$Main$viewNodeTextInput = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('New task...'),
					...
					_List_fromArray(
						[
							...
							A2($author$project$Main$size, model, 2)),
...
var $author$project$Main$RemoveNode = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$viewRemoveButton = function (id) {
	return A2(
		$author$project$Main$viewNodeActionButton,
		$author$project$Main$RemoveNode(id),
		_List_fromArray(
...
var $author$project$Main$viewNode = F3(
	function (model, isRoot, _v0) {
		var node = _v0;
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Main$styleFlex]))
						]),
					_List_fromArray(
						[
							(node.E ? $author$project$Main$crossedOut(model) : $elm$core$Basics$identity)(
							A2(
								$rtfeldman$elm_css$Html$Styled$span,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$author$project$Main$viewMarker(model),
										A3(
										$author$project$Main$viewNodeTextInput,
										model,
										node.H,
										$author$project$Main$TextChange(node.y))
									]))),
							A2(
							$rtfeldman$elm_css$Html$Styled$span,
							_List_Nil,
							_List_fromArray(
								[
									$author$project$Main$viewCrossoutButton(node.y),
									$author$project$Main$viewAddButton(node.y),
									(!_Utils_eq(node.y, $author$project$Main$rootId)) ? $author$project$Main$viewRemoveButton(node.y) : $rtfeldman$elm_css$Html$Styled$text('')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							A2($author$project$Main$viewNodes, model, node.s)
						]))
				]));
	});
var $author$project$Main$viewNodes = F2(
	function (model, list) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				A2($author$project$Main$viewNode, model, false),
				list));
	});
var $author$project$Main$Save = {$: 4};
...
var $author$project$Main$view = function (model) {
	var name = A2(
		...
		A2(
			...
			A2($elm$core$Dict$get, $author$project$Main$rootId, model.x)));
	return function (viewRootNode) {
		return function (body) {
			...
			$rtfeldman$elm_css$Html$Styled$toUnstyled(
				A2(
					...
					_List_fromArray(
						[viewRootNode, $author$project$Main$viewSaveButton]))));
	}(
		A2(
			$elm$core$Maybe$withDefault,
			...
			A2(
				$elm$core$Maybe$map,
				A2($author$project$Main$viewNode, model, true),
				A2($author$project$Main$makeNode, model.x, $author$project$Main$rootId))));
};
