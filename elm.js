...
var $author$project$Main$emptyModel = {
	nextId: $author$project$Main$nextId($author$project$Main$rootId),
	nodes: A3(
		$elm$core$Dict$insert,
		$author$project$Main$rootId,
		{children: _List_Nil, crossedOut: false, id: $author$project$Main$rootId, owner: $author$project$Main$rootId, text: 'My List'},
		$elm$core$Dict$empty)
};
var $author$project$Main$Model = F2(
	function (nodes, nextId) {
		return {nextId: nextId, nodes: nodes};
	});
...
var $author$project$Main$NodeInfo = F5(
	function (id, owner, text, crossedOut, children) {
		return {children: children, crossedOut: crossedOut, id: id, owner: owner, text: text};
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'owner',
				$elm$json$Json$Encode$int(node.owner)),
				_Utils_Tuple2(
				'text',
				$elm$json$Json$Encode$string(node.text)),
				_Utils_Tuple2(
				'crossedOut',
				$elm$json$Json$Encode$bool(node.crossedOut)),
				_Utils_Tuple2(
				'children',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, node.children))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nodes',
				$author$project$Main$encodeNodes(model.nodes)),
				_Utils_Tuple2(
				'nextId',
	...
	function (id, nodes) {
		...
		if (_v0.$ === 'Nothing') {
			...
			var removeChildren = A3(
				...
				A2($elm$core$List$map, $author$project$Main$removeNode, nodeInfo.children));
			return A3(
						...
						_Utils_update(
							model,
							{
								...
								nodes: A3(
									$elm$core$Dict$insert,
									model.nextId,
									{children: _List_Nil, crossedOut: false, id: model.nextId, owner: owner, text: ''},
									model.nodes)
							})));
			case 'CrossNode':
				var id = msg.a;
...
var $author$project$Main$makeNode = F2(
	function (dict, id) {
		return A2(
			$elm$core$Maybe$map,
			function (nodeInfo) {
				return $author$project$Main$Node(
					{
						children: A2(
							...
							_List_fromArray(
								[
									...
									A3(
										...
										$rtfeldman$elm_css$Css$px(height / 2))),
...
var $author$project$Main$taskFont = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$taskFont
						]))
				]),
			_List_Nil);
	});
var $author$project$Main$RemoveNode = function (a) {
	return {$: 'RemoveNode', a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							(node.crossedOut ? $author$project$Main$crossedOut(model) : $elm$core$Basics$identity)(
							A2(
								$rtfeldman$elm_css$Html$Styled$span,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										model,
										node.text,
										$author$project$Main$TextChange(node.id))
									]))),
							A2(
							$rtfeldman$elm_css$Html$Styled$span,
							_List_Nil,
							_List_fromArray(
								[
									$author$project$Main$viewCrossoutButton(node.id),
									$author$project$Main$viewAddButton(node.id),
									(!_Utils_eq(node.id, $author$project$Main$rootId)) ? $author$project$Main$viewRemoveButton(node.id) : $rtfeldman$elm_css$Html$Styled$text('')
								]))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					...
					_List_fromArray(
						[
							A2($author$project$Main$viewNodes, model, node.children)
						]))
				]));
	});
...
var $author$project$Main$view = function (model) {
	var name = A2(
		...
		A2(
			...
			A2($elm$core$Dict$get, $author$project$Main$rootId, model.nodes)));
	return function (viewRootNode) {
		...
		A2(
			...
			A2(
				...
				A2($author$project$Main$makeNode, model.nodes, $author$project$Main$rootId))));
};
