...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			nextId: $author$project$Main$rootId + 1,
			nodes: A3(
				$elm$core$Dict$insert,
				$author$project$Main$rootId,
				{children: _List_Nil, crossedOut: false, id: $author$project$Main$rootId, owner: -1, text: 'My List'},
				$elm$core$Dict$empty)
		},
...
var $author$project$Storage$set = _Platform_outgoingPort(
	'set',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
			...
			default:
				return _Utils_Tuple2(
					...
					$author$project$Storage$set(
						{
							key: 'nodes',
							value: $author$project$Main$encodeNodes(model.nodes)
						}));
		}
	});
...
var $author$project$Main$crossedOut = function (el) {
	var height = 2;
	return A2(
...
var $author$project$Main$viewMarker = A2(
...
var $author$project$Main$viewNodeTextInput = F2(
	function (text, msg) {
		return A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							(node.crossedOut ? $author$project$Main$crossedOut : $elm$core$Basics$identity)(
							A2(
								$rtfeldman$elm_css$Html$Styled$span,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$author$project$Main$viewMarker,
										A2(
					...
					_List_fromArray(
						[
							$author$project$Main$viewNodes(node.children)
						]))
				]));
	});
var $author$project$Main$viewNodes = function (list) {
	return A2(
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$viewNode(false),
			list));
};
...
var $author$project$Main$view = function (model) {
	return function (viewRootNode) {
		...
		A2(
			...
			A2(
				$elm$core$Maybe$map,
				$author$project$Main$viewNode(true),
